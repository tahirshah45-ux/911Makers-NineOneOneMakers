...
export default function IndustriesPage() {
  ...
  return (
    <div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            >
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-accent/8 border border-accent/20">
                ...
                <span className="text-accent text-sm font-medium">6 Industry Specializations</span>
              </div>
            </motion.div>
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center">
              <Link href="#industries-grid">
                <Button variant="primary" size="lg">
                  Explore Industries <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
              <Link href="/contact">
      ...
      {/* Industries Grid */}
      <section id="industries-grid" className="py-28 bg-background-secondary">
